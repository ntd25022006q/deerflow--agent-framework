# ═══════════════════════════════════════════════════════════════
# DEERFLOW AGENT FRAMEWORK v1.0 - GITHUB COPILOT ENFORCEMENT
# ═══════════════════════════════════════════════════════════════
# GitHub Copilot Integration
# Apply these rules to EVERY code suggestion, completion, and chat response
...
- All generated completions must be contextually aware of the surrounding code
- Completions must match the existing code style, indentation, and conventions
- Generated code must not introduce new dependencies without a comment explaining why
- Inline completions must be immediately usable without modification
...
- Reference specific files, line numbers, and standards when discussing code

# ═══════════════════════════════════════════════════════════════
# DEERFLOW AGENT FRAMEWORK v1.0 - TRAE ENFORCEMENT
# ═══════════════════════════════════════════════════════════════
# Trae AI Coding Assistant Integration
# Apply these rules to EVERY code generation, edit, and chat response
# VIOLATION OF ANY RULE = IMMEDIATE REJECTION
# ═══════════════════════════════════════════════════════════════

## TRAE BEHAVIOR DIRECTIVES

When operating within Trae, you MUST:

- Analyze the full project context including all open files and project structure before generating code
...
- Maintain consistency with Trae's built-in code intelligence and analysis features
...
## TRAE-SPECIFIC DIRECTIVES

### Code Generation Rules
- Leverage Trae's code intelligence features for accurate context analysis
- Ensure all generated code is compatible with Trae's built-in diagnostics
- When Trae provides code analysis warnings, address them before proceeding
- Use Trae's refactoring suggestions as input, but verify against Deerflow standards

### Agent Builder Integration
- When using Trae's agent builder features, ensure all custom agents follow Deerflow rules
- Agent-generated code must meet the same quality standards as manually written code
- Custom agent prompts should reference these Deerflow rules
- Test all agent-generated code against the verification checklist

### Context Management
- Trae maintains rich project context -- leverage this for accurate code generation
- When context is incomplete, request additional file context before generating code
- Verify generated code against the full project context, not just the active file
- Ensure cross-file references are accurate and imports resolve correctly

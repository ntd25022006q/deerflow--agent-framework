# ═══════════════════════════════════════════════════════════════
# DEERFLOW AGENT FRAMEWORK v1.0 - PEARAI ENFORCEMENT
# ═══════════════════════════════════════════════════════════════
# PearAI Integration
...
## PEARAI BEHAVIOR DIRECTIVES

When operating within PearAI, you MUST:

- Analyze the full project context before generating any code, including open tabs and project structure
...
- When using PearAI's inline edit feature, ensure edits maintain surrounding code consistency
...
## PEARAI-SPECIFIC DIRECTIVES

### Inline Edit Rules
- When PearAI suggests inline edits, they must maintain the surrounding code's indentation and style
- Edits must not break the file's existing structure or imports
- Each inline edit should be independently verifiable
- Inline edits must preserve existing comments and documentation

### Chat Interaction
- In PearAI's chat interface, provide complete, self-contained code blocks
- Reference specific files and line numbers when discussing changes
- When asked to explain code, trace the data flow and explain architectural decisions
- Always suggest tests alongside code changes

### Project Awareness
- Utilize PearAI's codebase indexing to understand project structure
- Ensure generated code is compatible with PearAI's supported language servers
- When generating new files, follow the project's established directory patterns
- Check for existing utilities or patterns before creating new ones

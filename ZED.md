# ═══════════════════════════════════════════════════════════════
# DEERFLOW AGENT FRAMEWORK v1.0 - ZED ENFORCEMENT
# ═══════════════════════════════════════════════════════════════
# Zed Editor AI Assistant Integration
# Apply these rules to EVERY code generation, edit, and response
# VIOLATION OF ANY RULE = IMMEDIATE REJECTION
# ═══════════════════════════════════════════════════════════════

## ZED BEHAVIOR DIRECTIVES

When operating within Zed's AI Assistant, you MUST:

- Analyze the full project context provided by Zed's project-wide indexing before generating code
- Ensure all generated code matches Zed's Rust-inspired performance and clarity philosophy
...
- Respect Zed's minimalist philosophy: clean, efficient, well-structured code
...
## ZED-SPECIFIC DIRECTIVES

### Code Generation Philosophy
- Zed values performance, clarity, and minimalism -- generated code should reflect these values
- Prefer explicit, readable code over clever but opaque implementations
- Every generated file should have a clear, focused purpose
- Code should be efficient without sacrificing readability

### Assistant Panel Interaction
- When responding in the Assistant panel, provide concise but complete answers
- Reference specific file paths and line numbers when discussing code
- Use Zed's multi-cursor and multi-file editing capabilities efficiently
- Leverage Zed's project-wide semantic search for context building

### Project Awareness
- Utilize Zed's project indexing to understand the full codebase structure
- When suggesting changes, consider the impact on the entire project, not just the target file
- Ensure generated code is compatible with Zed's built-in language servers (TypeScript, etc.)
- Respect Zed's task system -- break large changes into discrete, reviewable steps

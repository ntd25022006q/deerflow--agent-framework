# ═══════════════════════════════════════════════════════════════
# DEERFLOW AGENT FRAMEWORK v1.0 - MELTY ENFORCEMENT
# ═══════════════════════════════════════════════════════════════
# Melty AI Coding Assistant Integration
# Apply these rules to EVERY code generation, edit, and chat response
# VIOLATION OF ANY RULE = IMMEDIATE REJECTION
# ═══════════════════════════════════════════════════════════════

## MELTY BEHAVIOR DIRECTIVES

When operating within Melty, you MUST:

- Analyze the full project context before generating any code, leveraging Melty's codebase understanding
...
- Respect Melty's multi-file awareness when making cross-cutting changes
...
## MELTY-SPECIFIC DIRECTIVES

### Multi-File Awareness
- Melty has strong multi-file awareness -- leverage this when making cross-cutting changes
- When editing multiple files, verify that all imports and exports remain consistent
- Ensure changes to shared types or interfaces are reflected across all consuming files
- Use Melty's cross-file reference capabilities to trace dependencies before modifying shared code

### Code Intelligence
- Leverage Melty's codebase understanding to identify existing patterns before creating new ones
- When Melty suggests refactoring opportunities, evaluate them against Deerflow standards
- Use Melty's symbol navigation to verify that function signatures and types are correct
- Check for existing utilities and shared code before generating new implementations

### Chat and Edit Integration
- In Melty's chat interface, provide complete, self-contained code blocks
- Reference specific files and line numbers when discussing changes
- When making inline edits, verify the edit preserves file formatting and structure

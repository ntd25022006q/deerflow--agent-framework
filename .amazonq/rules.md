# ═══════════════════════════════════════════════════════════════
# DEERFLOW AGENT FRAMEWORK v1.0 - AMAZON Q ENFORCEMENT
# ═══════════════════════════════════════════════════════════════
...
## AMAZON Q BEHAVIOR DIRECTIVES

When operating within Amazon Q Developer, you MUST:

- Analyze the full project context before generating any code, including Amazon Q's codebase understanding
...
- Respect Amazon Q's enterprise security and compliance features
...
## AMAZON Q-SPECIFIC DIRECTIVES

### Code Generation Rules
- Amazon Q has deep knowledge of AWS services -- ensure all AWS integration code follows AWS best practices
- When generating AWS-related code, use the latest AWS SDK v3 patterns
- Ensure all AWS credentials are managed through IAM roles, never hardcoded
- Follow AWS Well-Architected Framework principles in generated code
- Use AWS CDK or CloudFormation best practices when generating infrastructure code

### Enterprise Compliance
- Follow the organization's security and compliance policies alongside Deerflow rules
- Respect IAM permissions and least-privilege access patterns
- Ensure generated code is compatible with the organization's CI/CD pipeline
- Follow data classification and handling policies for sensitive information

### Code Review Integration
- When Amazon Q provides code review suggestions, evaluate them against Deerflow standards
- Security findings from Amazon Q must be addressed with highest priority
- Performance recommendations should be validated with profiling data before implementation
- Use Amazon Q's security scans as a complement to manual code review
